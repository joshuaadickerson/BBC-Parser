...
class Message52 implements MessageInterface
{
    ...
    {
        return '<div class=\"quoteheader\">: Edsger Dijkstra</div><blockquote class=\"bbc_standard_quote\">If debugging is the process of removing software bugs, then programming must be the process of putting them in</blockquote>';
    }
}